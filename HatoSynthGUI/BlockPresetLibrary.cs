...
namespace HatoSynthGUI
{
    ...
    class BlockPresetLibrary
    {
        ...
        public List<BlockPreset> Presets = new List<BlockPreset>
        {
            ...
            new BlockPreset("Dynamics",      "Wrap",           31, new float[] {100, (float)Shaper.ShaperType.Wrap}),
            new BlockPreset("Dynamics",      "Shaper",         32, new float[] {100, (float)Shaper.ShaperType.HardClip}),
            ...
            new BlockPreset("Mic",           "Microphone",     42, new float[] {})
        };
    }
}
